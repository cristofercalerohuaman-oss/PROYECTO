...
from vehiculos import views as vehiculos_views # type: ignore
from django.conf import settings
from django.conf.urls.static import static
urlpatterns = [
    path('admin/', admin.site.urls),
    path('signup/', vehiculos_views.signup, name='signup'),
    ...
    path('accounts/logout/', auth_views.LogoutView.as_view(next_page='vehiculos:dashboard'), name='logout'),
